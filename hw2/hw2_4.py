...
train_error = y_inter - y_train
test_error = y_inter - y_test
...
plt.scatter(x, y, label='y_original', c='grey', s=5)
plt.plot(x_train, y_train, label='y_train', c='r')
plt.plot(x_test, y_inter, label='y_inter', c='g')
plt.ylim([-1.5, 1.5])
plt.legend()
plt.grid(color='gray', linestyle=':', linewidth=0.5)
plt.tight_layout()
plt.savefig(input_loc + '/figures/hw2_4_'+str(n)+'_'+str(std)+'.pdf', format='pdf', bbox_inches='tight') 
plt.show()
